 ...
 */
@Singleton
public class InternalWebSocketConnectionSustainer extends WebSocketConnectionSustainer {

    @Inject
    public InternalWebSocketConnectionSustainer(@Named("internal") WebSocketConnection connection) {
        super(connection);
    }
}

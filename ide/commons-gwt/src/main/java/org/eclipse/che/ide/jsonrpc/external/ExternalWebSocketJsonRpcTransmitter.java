 ...
 */
@Singleton
public class ExternalWebSocketJsonRpcTransmitter extends WebSocketJsonRpcTransmitter {

    @Inject
    public ExternalWebSocketJsonRpcTransmitter(@Named("external") WebSocketMessageTransmitter transmitter,

 ...
 */
@Singleton
public class InternalWebSocketJsonRpcResponseDispatcher extends WebSocketJsonRpcResponseDispatcher {
    @Inject
    public InternalWebSocketJsonRpcResponseDispatcher(@Named("internal") Map<String, JsonRpcResponseReceiver> receivers,
                                                      @Named("internal") JsonRpcRequestRegistry registry,

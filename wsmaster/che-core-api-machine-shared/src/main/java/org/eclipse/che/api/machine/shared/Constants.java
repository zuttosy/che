...
public class Constants {
    ...
    public static final String GET_ENVIRONMENT_OUTPUT_CHANNEL = "environment.output_channel";
    public static final String GET_ENVIRONMENT_STATUS_CHANNEL = "environment.status_channel";

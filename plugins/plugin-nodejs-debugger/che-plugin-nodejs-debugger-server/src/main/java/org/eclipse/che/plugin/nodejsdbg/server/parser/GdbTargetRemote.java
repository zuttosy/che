...
public class GdbTargetRemote {
     ...
     * Factory method.
     */
    public static GdbTargetRemote parse(DbgOutput dbgOutput) throws NodeJsDebuggerParseException, DebuggerException {
        ...
        throw new NodeJsDebuggerParseException(GdbTargetRemote.class, output);
    }
}

...
public class GdbInfoProgram {
     ...
     * Factory method.
     */
    public static GdbInfoProgram parse(DbgOutput dbgOutput) throws NodeJsDebuggerParseException {
        ...
        throw new NodeJsDebuggerParseException(GdbInfoProgram.class, output);
    }
}

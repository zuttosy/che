...
public class GdbInfoLine {
     ...
     * Factory method.
     */
    public static GdbInfoLine parse(DbgOutput dbgOutput) throws NodeJsDebuggerParseException {
        ...
        throw new NodeJsDebuggerParseException(GdbInfoLine.class, output);
    }
}

...
import org.eclipse.che.plugin.gdb.server.exception.NodejsDebuggerParseException;
...
public class DbgVersionTest {
    ...
    @Test(expectedExceptions = NodejsDebuggerParseException.class)

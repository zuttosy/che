...
public class GdbDebuggerTest {
    ...
    public void beforeClass() throws Exception {
        file = NodeJsDebugConnectorTest.class.getResource("/hello").getFile();
        sourceDirectory = Paths.get(NodeJsDebugConnectorTest.class.getResource("/h.cpp").getFile());
...
//        stepInto();
    ...
    private void initializeDebugger() throws DebuggerException {
        ...
        NodejsDebuggerFactory nodejsDebuggerFactory = new NodejsDebuggerFactory();
        gdbDebugger = nodejsDebuggerFactory.create(properties, events::add);
